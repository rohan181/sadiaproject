  ...
  return (
    <main>
      ...
      <section className="allMapsSection">
        ...
        <div className="allMapsGrid">{analysisModes.map((mode) => <MapPreview key={mode.id} mode={mode.id} active={analysisMode === mode.id} onOpen={() => { setAnalysisMode(mode.id); if (mode.id === "facility") setFacility(true); setMapExpanded(true); }} />)}</div>
      </section>
